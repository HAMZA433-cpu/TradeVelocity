...
const Community = () => {
    ...
    const fetchDiscussions = async () => {
        try {
            const response = await axios.get('${API_BASE_URL}/api/community/discussions', {
    ...
    const fetchDiscussion = async (discussionId) => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/community/discussions/${discussionId}`);
            if (response.data.success) {
    ...
    const createDiscussion = async (e) => {
        ...
        try {
            const response = await axios.post('${API_BASE_URL}/api/community/discussions', {
                ...newDiscussion,
                user_id: user.id
            });
    ...
    const addMessage = async (e) => {
        ...
        try {
            const response = await axios.post(
                `${API_BASE_URL}/api/community/discussions/${selectedDiscussion.id}/messages`,
                {
                    content: newMessage,
                    user_id: user.id
                }
    ...
    const likeDiscussion = async (discussionId) => {
        try {
            await axios.post(`${API_BASE_URL}/api/community/discussions/${discussionId}/like`);
