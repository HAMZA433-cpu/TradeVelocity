    ...
    return (
        <div className="min-h-screen bg-cyberpunk text-white relative overflow-hidden">
            ...
            <nav className="relative z-50 border-b border-white/10 backdrop-blur-sm bg-black/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex items-center justify-between h-16">
                        <Link to="/" className="text-xl sm:text-2xl font-black font-jetbrains">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            <Link
                                to="/pricing"
                                className="font-jetbrains text-xs hover:text-neon-green transition-colors tracking-wider"
                            >
                                PRICING
                            </Link>
                            <Link
                                to="/login"
                                className="font-jetbrains text-xs border border-white/20 px-4 py-2 hover:border-neon-green hover:text-neon-green transition-all"
                            >
                                LOG IN
                            </Link>
                            <Link to="/register">
                        ...
                        >
                            <div className="px-4 py-6 space-y-4">
                                <Link
                                    ...
                                    className="block font-jetbrains text-sm hover:text-neon-green transition-colors tracking-wider py-2"
                                >
                                    PRICING
                                </Link>
                                <Link
                                    to="/login"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className="block font-jetbrains text-sm border border-white/20 px-4 py-3 text-center hover:border-neon-green hover:text-neon-green transition-all"
                                >
                                    LOG IN
                                </Link>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
                ...
                >
                    <div className="inline-flex flex-wrap items-center justify-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 border border-neon-green/30 bg-neon-green/5 font-jetbrains text-[10px] sm:text-xs text-neon-green">
                        <Activity className="w-3 h-3 sm:w-4 sm:h-4 animate-pulse" />
                        <span className="text-center">LIVE MARKET • REAL-TIME • &lt;10MS</span>
                    </div>
                </motion.div>
                ...
                >
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black mb-6 font-jetbrains leading-none tracking-tight flex flex-col items-center">
                        <RewindRewriteText
                            text="TRADE AT THE"
                    ...
                    <motion.p
                        ...
                        className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-400 mb-10 max-w-3xl mx-auto font-jetbrains px-4"
                    >
                        High-frequency trading platform with institutional-grade execution.
                        <br className="hidden sm:block" />
                        <span className="sm:hidden"> </span>
                        Zero latency. Maximum precision. Professional tools.
                    </motion.p>
                </motion.div>
                ...
                >
                    <div className="glassmorphism-dark rounded-lg overflow-hidden border border-white/10 h-[300px] sm:h-[400px] lg:h-[500px] flex flex-col relative transform-gpu">
                        {/* Order Book Header */}
                        <div className="bg-black/50 border-b border-white/10 px-3 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 shrink-0">
                            <div className="flex items-center gap-2 sm:gap-3">
                                <div className="w-2 h-2 bg-neon-green rounded-full animate-pulse" />
                                <span className="font-jetbrains text-xs sm:text-sm text-gray-300">
                                    LIVE ORDER BOOK
                                </span>
                                <span className="font-jetbrains text-[10px] sm:text-xs text-gray-500">
                                    BTC/USD
                                </span>
                            </div>
                            <div className="flex items-center gap-3 sm:gap-6">
                                <div className="font-jetbrains text-[10px] sm:text-xs text-gray-500">
                                    SPREAD: <span className="text-neon-green">0.01%</span>
                                </div>
                                <div className="font-jetbrains text-[10px] sm:text-xs text-gray-500 hidden sm:block">
                                    VOL: <span className="text-white">2.4B</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-black/50 border-t border-white/10 px-6 py-6 text-center shrink-0">
                            ...
                            <motion.div
                                ...
                                className="text-3xl sm:text-4xl lg:text-6xl font-bold text-neon-green font-jetbrains"
                            >
                                $42,567.89
                            </motion.div>
                            <div className="text-sm text-gray-400 mt-2 font-jetbrains">
                                <span className="text-neon-green">↑ +2.47%</span> • 24h
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-20 sm:mb-32"
                >
                    {[
                ...
                >
                    <div className="text-center mb-12 sm:mb-16">
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-4 font-jetbrains text-white px-4">
                            PLATFORM <span className="text-neon-green">FEATURES</span>
                        </h2>
                        <p className="text-gray-400 font-jetbrains text-xs sm:text-sm max-w-2xl mx-auto px-4">
                ...
                >
                    ...
                    <div className="overflow-x-auto table-container glassmorphism border border-white/10">
                        <div className="min-w-[600px] sm:min-w-full">
                            <div className="grid grid-cols-5 bg-black/50 border-b border-white/10 px-4 sm:px-6 py-3 sm:py-4 font-jetbrains text-[10px] sm:text-xs text-gray-500 tracking-widest">
                                <div>PAIR</div>
                        ...
                        {[
                            {
                                name: 'Sarah Chen',
                                role: 'Day Trader',
                                text: 'The execution speed is incredible. I\'ve tried many platforms, but TradeVelocity is by far the fastest.',
                                rating: 5
                            },
                            {
                ...
                >
                    <div className="glassmorphism border border-neon-green/30 p-16 text-center">
                        ...
                        <p className="text-gray-400 font-jetbrains text-lg mb-10 max-w-2xl mx-auto">
                            Join thousands of traders executing at the speed of light
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-6 py-8">
                    <div className="flex justify-between items-center font-jetbrains text-xs">
                        <div className="text-gray-600">
                            © 2026 TradeVelocity. High-Frequency Trading Platform.
                        </div>
                        <div className="flex gap-6">
                            <Link to="/terms" className="text-gray-600 hover:text-neon-green transition-colors">
                                Terms
                            </Link>
                            <Link to="/privacy" className="text-gray-600 hover:text-neon-green transition-colors">
                                Privacy
                            </Link>
