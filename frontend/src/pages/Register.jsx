            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 font-jetbrains text-sm">
                        Rejoignez la plateforme de trading haute-fréquence
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative py-4">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-black/50 px-4 text-gray-400 font-jetbrains">OU</span>
                            </div>
                        </div>
                        ...
                        {/* Login Link */}
                        <div className="text-center text-gray-400 font-jetbrains text-sm pt-4">
